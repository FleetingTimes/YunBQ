<template>
  <div class="square-container">
    ...
    <section class="placeholder">
      <div class="card">
        <div class="card-title">欢迎来到广场</div>
        <div class="card-desc">后续可在此展示公开便签的弹幕或列表。</div>
      </div>
    </section>
  </div>
</template>
...
.placeholder { display: grid; grid-template-columns: 1fr; gap: 12px; }
